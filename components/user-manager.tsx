    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <form onSubmit={handleUserSubmit} className="space-y-4">
                  ...
                  <div className="p-3 bg-blue-50 border border-blue-200 rounded-md">
                    <p className="text-sm text-blue-800">
                      <strong>Note:</strong> Creating this user will
                      automatically generate an authentication account with:
                    </p>
        ...
        <TabsContent value="colleges" className="space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="text-lg font-medium">Colleges</h3>
            <Button
            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleCollegeSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="collegeAbbrv">Abbreviation</Label>
                      <Input
                        id="collegeAbbrv"
                        value={collegeFormData.abbrv}
                        onChange={(e) =>
                          setCollegeFormData({
                            ...collegeFormData,
                            abbrv: e.target.value,
                          })
                        }
                        placeholder="CIVE"
                        required
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        placeholder="College of Informatics and Virtual Education"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-2">
                        {getCollegeProgrammes(college.id!).length} programme(s)
                      </p>
                    </div>
                    <Button
                      variant="outline"
          ...
          {showProgrammeForm && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Add a new programme to a college
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleProgrammeSubmit} className="space-y-4">
                  <div>
                    <Label htmlFor="programmeCollege">College</Label>
                    <Select
                      value={programmeFormData.collegeId}
                      onValueChange={(value) =>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <Label htmlFor="programmeAbbrv">Abbreviation</Label>
                      <Input
                        id="programmeAbbrv"
                        value={programmeFormData.abbrv}
                        onChange={(e) =>
                          setProgrammeFormData({
                            ...programmeFormData,
                            abbrv: e.target.value,
                    ...
                    <div>
                      <Label htmlFor="programmeName">Name</Label>
                      <Input
                        id="programmeName"
                    ...
                    <div>
                      <Label htmlFor="programmeYears">Years</Label>
                      <Input
                        id="programmeYears"
                        type="number"
                        value={programmeFormData.years}
                        onChange={(e) =>
                          setProgrammeFormData({
                            ...programmeFormData,
          ...
          <div className="grid gap-4">
            {programmes.map((programme) => {
              const college = colleges.find(
                (c) => c.id === programme.collegeId
              );
              return (
                <Card key={`${programme.collegeId}-${programme.id}`}>
                  <CardContent className="pt-6">
                    <div className="flex justify-between items-start">
                      <div>
                        <h4 className="font-semibold">{programme.name}</h4>
                        <p className="text-sm text-muted-foreground">
                          {programme.abbrv} • {programme.years} years
                        </p>
                        <p className="text-xs text-muted-foreground">
                          {college?.name} ({college?.abbrv})
                        </p>
